        ...
        <React.Fragment>
           <div className="container" style={{marginTop:"200px"}}>
                <div className="row rwo">
                    <h1 id="ss" style={{marginBottom:"100px" , color:"blue"}}>Оптимизация <br></br> инфраструктуры</h1>
                    <div className="col-6 clk">
                        <img src={img1}/>
                    </div>
                    <div className="col-6" id="col-6" style={{height:"500px"}}>
                        
                        <h3 className="res">Наши опытные специалисты помогут оптимизировать вашу инфраструктуру.</h3>
